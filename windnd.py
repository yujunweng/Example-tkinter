...
def hook_dropfiles(tkwindow_or_winfoid,func=_func,force_unicode=False):
    ...
    **kw:
    ...
    hwnd = tkwindow_or_winfoid.winfo_id()\
           ...
           else tkwindow_or_winfoid	#else這段 會引發錯誤
    ...
    if platform.architecture()[0] == "32bit":
        ...
        argtype = ctypes.c_uint64	# 表示 C 64 位unsigned int數據類型。通常是 c_ulonglong.

    # WINFUNCTYPE using the stdcall calling convention
